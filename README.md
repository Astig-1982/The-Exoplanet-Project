...
## Table Of Contents:
  ...
  * [Testing:](#testing)
    + [Testing Stories:](#testing-stories)
      ...
      - [Register with an account:](#register-with-an-account)
      - [Deleting and account:](#deleting-and-account)
      - [Sign out of an account:](#sign-out-of-an-account)
      - [Inserting an exoplanet:](#inserting-an-exoplanet)
      - [Calculating the user's weight on each exoplanet:](#calculating-the-user-s-weight-on-each-exoplanet)
  ...
  * [Deployment:](#deployment)
    + [Deploying The Exoplanet Project to Heroku:](#deploying-the-exoplanet-project-to-heroku)
  * [Credits:](#credits)
    + [Content:](#content)
    + [Media:](#media)
...
The main background image of the app is a representation of the recently confirmed exoplanet **Trappist 1 e** and it has been designed by [NASA/Jet Propulsion Laboratory-Caltech](https://www.jpl.nasa.gov/) within their [SPACE TOURISM](https://solarsystem.nasa.gov/resources/682/space-tourism-posters/) program. Please see at the [Credits](#credits) section the source where the image in the app was taken from. I have chosen this image because it represents the travelers' excitement upon arrival on a foreign planet, with them browsing through the window of their spaceship. In my opinion, this can as well represent the users' excitement when browsing through exoplanets in the app, a brief virtual trip through outer space.
...
* The **photo representing the location of an exoplanet's mass** on wikipedia was sourced from [wikipedia.org](https://en.wikipedia.org/wiki/Kepler-186f)
